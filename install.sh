...
if `cat /etc/redhat-release | grep -qi 'release 7'` && ! rpm -q epel-release; then sudo su - -c "yum -y install https://dl.fedoraproject.org/pub/epel/epel-release-latest-7.noarch.rpm"; fi
